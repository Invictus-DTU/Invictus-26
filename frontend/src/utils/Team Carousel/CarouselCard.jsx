    ...
    >
      ...
      >
        ...
        <div 
          ...
          <div className="text-center [font-family:'Orbitron',sans-serif] font-[800]">
            <p className="bg-gradient-to-b invictus-text from-[#998154] to-[#6E5B1D] bg-clip-text text-[1em] sm:text-[1.1em] text-transparent">
              {personInfo.name}
            </p>
          ...
          <div className="group p-1 rounded-lg border-2 border-[#998154]/60 hover:bg-[#998154] hover:scale-110 transition-all 
          duration-300 cursor-pointer">
            <a href={personInfo.ln_link} target="_blank" rel="noopener noreferrer">
            {/* default state */}
            <Linkedin size={20} strokeWidth={2} color='#998154' className="group-hover:hidden" />
            {/* hover state */}
            <Linkedin size={20} color='#998154' strokeWidth={0} className="fill-current text-white hidden group-hover:block" />
            </a>
          </div>
           { personInfo.ig_link && <div className="group p-1 rounded-lg border-2 border-[#998154]/60 hover:bg-[#998154] hover:scale-110 transition-all 
          duration-300 cursor-pointer">
            <a href={personInfo.ig_link} target="_blank" rel="noopener noreferrer">
            {/* default state */}
            <Instagram size={20} strokeWidth={2} color='#998154' className="group-hover:hidden" />
            {/* hover state */}
            <Instagram size={20} color='#998154' strokeWidth={2} className="hidden fill-current text-white group-hover:block" />
            </a>
          </div> }
          </div>
